...
public class CarInventory {
    public static void main(String[] args) {
      ...
      for( int i = 0; i <cars.length ; i++){
        ...
        System.out.println("countOfCivic = " + countOfH);
        System.out.println("countOfChevrolet = " + countOfC);
        ...
        // task 3
        //print make and model seperatley in this format
        //Honda-Civic -->
        //car make is honda and model civic
...
//        }
        ...
        for(String each : cars){
            if(each.startsWith("Honda")){
                String[] splittedHonda= each.split("-");
                System.out.println(" brand is " + splittedHonda[0] + " model is " + splittedHonda[1]);
            }
        }
...
//        }
        ...
        System.out.println("===========car with model has only 2 character ========= ");
        //find all the car with model has only 2 charachters
        //print the out
        // get the count
        ...
        for (String eachCar1: cars){
            ...
            if( eachCarSplitted[1].length() == 2){
             //   System.out.println("eachCar = " + eachCar1);
                ++cntOf2CharModel;
            }
        }
