...
public class SearchingSomethingInTheString2 {
    ...
    public static void main(String[] args) {
        ...
        String myName = "back baw black baw sheep back";
...
//        }
        ...
        for (int x = 0; x <= lastCharIndex - 2; ++x) {
            ...
            if (currentChar.equalsIgnoreCase("baw")) {
                ++counter;
                System.out.println("the index of baw : " + x);
            }
